      ...
      <div class="contact_section layout_padding">
         <div class="container">
            <div class="contact_main">
               ...
               <a href="sellreg.php"><button style="color:blue;" class="btn info">SELLER</button></a>
               ...
               <form action="/action_page.php">
                  ...
                  <div class="form-group">
                     <input type="text" class="email-bt" placeholder="Email" name="semail">
                  </div>
                  <div class="form-group">
                     <input type="text" class="email-bt" placeholder="Shop Name" name="sshop">
                  </div>
                  <div class="form-group">
                     <input type="text" class="email-bt" placeholder="Phone Number" name="sphnnum">
                  </div>
                  <div class="form-group">
